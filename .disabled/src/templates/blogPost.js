        ...
        <Layout
            ...
            meta={[
                ...
                },
                {
                    ...
                    content: t(`blog.section.${data.mdx.frontmatter.section ?? "blog"}.name`),
                },
                {
                    name: "keywords",
                ...
                <article>
                    ...
                    <span className={styles.meta}>
                        ...
                        {data.mdx.frontmatter.section && (
                            <>
                                {" | "}
                                <Link to={`/blog/${data.mdx.frontmatter.section}`}>
                                    {t(`blog.section.${data.mdx.frontmatter.section}.name`)}
                                </Link>
                            </>
                        )}
                    </span>
