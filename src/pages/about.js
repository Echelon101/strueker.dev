                    ...
                    <div className={styles.skills}>
                        ...
                        <div className={styles.skillList}>
                            {props.data.allSkillsJson.nodes.map((skill) => {
                                return skill.href ? (
                                    <a
                                        className={styles.skill + " " + styles["skill_" + skill.type]}
                                        href={skill.href}
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                    ...
                                    <span className={styles.skill + " " + styles["skill_" + skill.type]}>
                                        {skill.name}
                                    </span>
                                );
                            })}
                    ...
                    <div className={projectStyles.projectList}>
                        {props.data.allProjectsJson.nodes.map((project) => {
                            return (
                                ...
                                >
                                    <div className={projectStyles.projectCardImage}>
                                        <div className={projectStyles.projectCardBg}>
                                            <GatsbyImage
                ...
                <div>
                    ...
                    <div className={styles.careerContainer}>
                        ...
                        {career.map((careerEntry) => {
                            return (
                                <div
                                    className={styles.entry + " " + styles["entryType" + careerEntry.type]}
                                    key={careerEntry.id}
                                >
                                    <div className={styles.entryContent}>
                                        <span className={styles.date}>
                                            {careerEntry.startDate && careerEntry.startDate[lang]
                                                ? careerEntry.startDate[lang]
                                                : ""}
                                            {careerEntry.endDate && careerEntry.endDate[lang]
                                                ? " - " + careerEntry.endDate[lang]
                                                : ""}
                                        </span>
                                        <span className={styles.title}>
                                            {careerEntry.type == "education" && <GraduationCap />}
                                            {careerEntry.type == "jobexperience" && <Briefcase />}
                                            {careerEntry.title[lang]}
                                        </span>
                                        {careerEntry.description && careerEntry.description[lang] && (
                                            <p>{careerEntry.description[lang]}</p>
                                        )}
                                        {careerEntry.externalLink && (
                                            <a href={careerEntry.externalLink} target="_blank" rel="noreferrer">
                                                <ExternalLink />
                                                {(() => {
                                                    // eslint-disable-next-line no-undef
                                                    let url = new URL(careerEntry.externalLink);
                                                    return url.hostname;
                                                })()}
                                            </a>
                                        )}
