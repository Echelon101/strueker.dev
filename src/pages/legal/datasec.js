      ...
      <section>
        <article>
          ...
          <p>
            ...
            sie erhoben wurden, bestimmt sich nach den Vorgaben des Art 6 Abs. 4
            DSGVO. <br />
          ...
          <p>
            ...
            gesetzlichen Vorgaben entsprechenden Grundlage. <br />
          </p>
          ...
          <p>
            ...
            &quot;Privacy-Shield&quot; zertifizierten US-Verarbeiter gehören
            oder auf Grundlage besonderer Garantien, wie z.B. vertraglicher
          ...
          <p>
            ...
            Cookies bitten (z.B. im Rahmen einer Cookie-Einwilligung), ist die
            Rechtsgrundlage dieser Verarbeitung Art. 6 Abs. 1 lit. a. DSGVO.
            Ansonsten werden die personenbezogenen Cookies der Nutzer
            entsprechend den nachfolgenden Erläuterungen im Rahmen dieser
            Datenschutzerklärung auf Grundlage unserer berechtigten Interessen
            ...
            DSGVO) oder sofern der Einsatz von Cookies zur Erbringung unserer
            vertragsbezogenen Leistungen erforderlich ist, gem. Art. 6 Abs. 1
            lit. b. DSGVO, bzw. sofern der Einsatz von Cookies für die
            Wahrnehmung einer Aufgabe, die im öffentlichen Interesse liegt
            erforderlich ist oder in Ausübung öffentlicher Gewalt erfolgt, gem.
          ...
          <p>
            <span className="ts-muster-content">
              ...
              gem. Art. 6 Abs. 1 lit. f DSGVO branchenübliche Trackingmaßnahmen
              ein, soweit diese für den Betrieb des Affiliatesystems
              erforderlich sind. Nachfolgend klären wir die Nutzer über die
              ...
              Leistungen Dritter nach einem Vertragsschluss angeboten werden).
              Die Betreiber der jeweiligen Webseiten erhalten eine Provision,
              wenn Nutzer den Affiliate-Links folgen und anschließend die
              Angebote wahrnehmen.
              <br />
              <br />
              ...
              Onlineangebot für ein Angebot interessiert hat, das Angebot
              wahrgenommen, d.h. z.B. einen Vertrag mit dem Anbieter
              abgeschlossen hat. Die Online-Kennung ist jedoch insoweit
              personenbezogen, als dem Partnerunternehmen und auch uns, die
              Online-Kennung zusammen mit anderen Nutzerdaten vorliegen. Nur so
              kann das Partnerunternehmen uns mitteilen, ob derjenige Nutzer das
          ...
          <p>
            <span className="ts-muster-content">
              ...
              Partnerprogramms von Amazon EU, das zur Bereitstellung eines
              ...
              Sie den Partnerlink auf dieser Website geklickt und anschließend
          ...
          <p>
            <span className="ts-muster-content">
              ...
              <br />
              <br />
              Die im Rahmen der Kommentare und Beiträge mitgeteilte
              Informationen zur Person, etwaige Kontakt- sowie
              Websiteinformationen als auch die inhaltlichen Angaben, werden von
          ...
          <p>
            <span className="ts-muster-content">
              ...
              Nutzern mitgeteilte E-Mailadresse an Gravatar zwecks Prüfung, ob
              zu ihr ein Profil gespeichert ist, verschlüsselt übermittelt. Dies
              ist der einzige Zweck der Übermittlung der E-Mailadresse und sie
              wird nicht für andere Zwecke verwendet, sondern danach gelöscht.
              <br />
              <br />
              Die Nutzung von Gravatar erfolgt auf Grundlage unserer
              berechtigten Interessen im Sinne des Art. 6 Abs. 1 lit. f) DSGVO,
              da wir mit Hilfe von Gravatar den Beitrags- und
              ...
              Browser und einem Onlineservice notwendig ist. Nähere
              Informationen zur Erhebung und Nutzung der Daten durch Gravatar
              ...
              dass es auch möglich ist eine anonyme oder gar keine E-Mailadresse
          ...
          <p>
            <span className="ts-muster-content">
              Unsere Podcasts werden auf der Plattform „Soundcloud“, angeboten
              von SoundCloud Limited, Rheinsberger Str. 76/77, 10115 Berlin,
              Deutschland gespeichert und werden von dieser aus Platform
              wiedergegeben.
              <br />
              <br />
              ...
              messen, welche Podcasts in welchem Umfang gehört werden und diese
              Information pseudonym für statistische und betriebswirtschaftliche
              Zwecke verarbeiten. Hierzu können Cookies in den Browsern der
              Nuzer gespeichert und zwecks Bildung von Nutzerprofilen, z.B. für
              Zwecke der Ausgabee von Anzeigen, die den potentiellen Interessen
              der Nutzer entsprechen, verarbeitet werden. Im Fall von Nutzern,
              die bei Soundcloud registriert sind, kann Soundcloud die
              ...
              Analyse sowie Optimierung unseres Audioangebotes gem. Art. 6 Abs.
              1 lit. f. DSGVO. <br />
              <br />
              Weitere Informationen und Widerspruchsmöglichkeiten finden sich in
              der Datenschutzerklärung von Soundcloud:{" "}
              <a
                target="_blank"
                rel="noreferrer"
          ...
          <p>
            <span className="ts-muster-content">
              Wir setzen zu Zwecken der Kommunikation den WhatsApp-Messenger ein
              und bitten Sie die nachfolgenden Hinweise zu der
              Funktionsfähigkeit, der Verschlüsselung, Risiken von WhatsApp,
              Nutzung der Metadaten innerhalb der Facebook-Unternehmensgruppe
              und Ihren Widerspruchsmöglichkeiten zu beachten.
              <br />
              <br />
              Sie müssen WhatsApp nicht nutzen und können uns auf alternativen
              Wegen, z.B. via Telefon oder E-Mail kontaktieren. Bitte nutzen Sie
              die Ihnen mitgeteilten Kontaktmöglichkeiten oder nutzen die
              angegebenen Kontaktmöglichkeiten auf unserer Webseite.
              <br />
              Bei WhatsApp (WhatsApp Inc. WhatsApp Legal 1601 Willow Road Menlo
              Park, California 94025, USA) handelt es sich um einen
              US-Amerikanischen Dienst, was bedeutet, dass die von Ihnen via
              WhatsApp übersandten Daten zuerst an WhatsApp in die USA
              übermittelt werden können, bevor sie uns zugeleitet werden.
              <br />
              <br />
              WhatsApp ist jedoch unter dem Privacy-Shield-Abkommen zertifiziert
              und sichert daher zu, das europäische und das schweizer
              ...
              <br />
              WhatsApp sichert ebenfalls zu, dass die Kommunikationsinhalte
              (d.h. der Inhalt Ihrer Nachricht und angehängte Bilder)
              Ende-zu-Ende verschlüsselt werden. Das bedeutet, dass der Inhalt
              der Nachrichten nicht einsehbar ist, nicht einmal durch WhatsApp
              selbst. Sie sollten immer eine aktuelle Version von WhatsApp
              nutzen, damit die Verschlüsselung der Nachrichteninhalte
              sichergestellt ist.
              <br />
              <br />
              Wir weisen unsere Kommunikationspartner jedoch darauf hin, dass
              WhatsApp zwar nicht den Inhalt sehen, aber in Erfahrung bringen
              kann, dass und wann Kommunikationspartner mit uns kommunizieren
              ...
              Standortinformationen (sog. Metadaten) verarbeitet. Bis auf die
              verschlüsselten Inhalte, ist eine Übermittlung der Daten der
              Kommunikationspartner innerhalb der Facebook-Unternehmensgruppe,
              insbesondere zu Zwecken der Optimierung der jeweiligen Dienste und
              Zwecken der Sicherheit, möglich. Ebenfalls sollten
              Kommunikationspartner, zumindest solange sie dem nicht
              widersprochen haben, davon ausgehen, dass ihre von WhatsApp
              verarbeiteten Daten für Zwecke des Marketings oder Anzeige auf
              Nutzer zugeschnittener Werbung verwendet werden können.
              <br />
              <br />
              Sofern wir Kommunikationspartner um eine Einwilligung vor der
              Kommunikation mit ihnen via WhatsApp bitten, ist die
              Rechtsgrundlage unserer Verarbeitung ihrer Daten Art. 6 Abs. 1
              lit. a. DSGVO. Im Übrigen, falls wir nicht um eine Einwilligung
              bitten und sie z.B. von sich aus Kontakt mit uns aufnehmen, nutzen
              wir WhatsApp im Verhältnis zu unseren Vertragspartnern sowie im
              Rahmen der Vertragsanbahnung als eine vertragliche Maßnahme gem.
              Art. 6 Abs. 1 lit. b. DSGVO und im Fall anderer Interessenten und
              Kommunikationspartner auf Grundlage unserer berechtigten
              ...
              <br />
              <br />
              Weitere Angaben zu Zwecken, Arten und Umfang der Verarbeitung
              Ihrer Daten durch WhatsApp, sowie die diesbezüglichen Rechte und
              Einstellungsmöglichkeiten zum Schutz Ihrer Privatsphäre, können
              Sie den Datenschutzhinweisen von WhatsApp entnehmen:{" "}
              <a
                target="_blank"
                rel="noreferrer"
              ...
              widersprechen. Im Fall des Abonnements von Nachrichten (auch
              bekannt als „Broadcasts“) über WhatsApp können Sie unsere
              entsprechende Telefonnummer aus deren Kontakten löschen sowie uns
              zur Austragung Ihres Kontaktes aus unserem Verzeichnis auffordern.
              Bei laufenden individuellen Anfragen oder Kommunikationen, können
              Sie uns ebenfalls auffordern, die Kommunikation nicht über
              WhatsApp fortzusetzen sowie die Kommunikationsinhalte zu löschen.{" "}
              <br />
              <br />
              Im Fall der Kommunikation via WhatsApp löschen wir die
              WhatsApp-Nachrichten, sobald wir davon ausgehen können, etwaige
              Auskünfte der Nutzer beantwortet zu haben, wenn kein Rückbezug auf
              eine vorhergehende Konversation zu erwarten ist und der Löschung
              keine gesetzlichen Aufbewahrungspflichten entgegenstehen.
              <br />
              <br />
              Ferner weisen wir Sie darauf hin, dass wir die uns mitgeteilten
              Kontaktdaten ohne Ihre Einwilligung nicht an WhatsApp übermitteln
              (z.B., durch eine von uns ausgehende Kontaktaufnahme mit Ihnen via
              WhatsApp).
              <br />
              <br />
              Zum Abschluss möchten wir darauf hinweisen, dass wir uns aus
              Gründen Ihrer Sicherheit vorbehalten, Anfragen über WhatsApp nicht
              zu beantworten. Das ist der Fall, wenn z.B. Vertragsinterna
              besonderer Geheimhaltung bedürfen oder eine Antwort über den
              Messenger den formellen Ansprüchen nicht genügt. In solchen Fällen
          ...
          <p>
            <span className="ts-muster-content">
              ...
              Art. 6 Abs. 1 lt. f. DSGVO i.V.m. § 7 Abs. 3 UWG. <br />
              <br />
          ...
          <p>
            <span className="ts-muster-content">
              ...
              einsehen: [LINK ZU DEN DATENSCHUTZBESTIMMUNGEN]. Der
          ...
          <p>
            <span className="ts-muster-content">
              ...
              und Ihrem System, als auch Ihre IP-Adresse und Zeitpunkt des
              Abrufs erhoben. <br />
              <br />
              ...
              den statistischen Erhebungen gehört ebenfalls die Feststellung, ob
              die Newsletter geöffnet werden, wann sie geöffnet werden und
              welche Links geklickt werden. Diese Informationen können aus
              technischen Gründen zwar den einzelnen Newsletterempfängern
              zugeordnet werden. Es ist jedoch weder unser Bestreben, noch,
              sofern eingesetzt, das des Versanddienstleisters, einzelne Nutzer
              zu beobachten. Die Auswertungen dienen uns viel mehr dazu, die
              Lesegewohnheiten unserer Nutzer zu erkennen und unsere Inhalte auf
          ...
          <p>
            <span className="ts-muster-content">
              ...
              berechtigten Interessen (d.h. Interesse an der Analyse,
              Optimierung und wirtschaftlichem Betrieb unseres Onlineangebotes
              im Sinne des Art. 6 Abs. 1 lit. f. DSGVO) verarbeitet.
              <br />
              <br />
          ...
          <p>
            <span className="ts-muster-content">
              ...
              Analytics, bei dem die Nutzeranalyse auf Grundlage einer
              pseudonymen Nutzer-ID erfolgt und damit ein pseudonymes Profil des
              Nutzers mit Informationen aus der Nutzung verschiedener Geräten
          ...
          <p>
            <span className="ts-muster-content">
              ...
              dieser Webseite werden nur auf unserem Server gespeichert und
          ...
          <p>
            <span className="ts-muster-content">
              ...
              Anbieters Vimeo Inc., Attention: Legal Department, 555 West 18th
              Street New York, New York 10011, USA, einbinden.
          ...
          <p>
            <span className="ts-muster-content">
              ...
              Anbieters Google Ireland Limited, Gordon House, Barrow Street,
              Dublin 4, Irland, ein. Nach Angaben von Google werden die Daten
              der Nutzer allein zu Zwecken der Darstellung der Schriftarten im
              Browser der Nutzer verwendet. Die Einbindung erfolgt auf Grundlage
          ...
          <p>
            <span className="ts-muster-content">
              Wir binden die Funktion zur Erkennung von Bots, z.B. bei Eingaben
              in Onlineformularen (&quot;ReCaptcha&quot;) des Anbieters GGoogle
              Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland,
          ...
          <p>
            <span className="ts-muster-content">
              Wir binden die Landkarten des Dienstes &quot;OpenStreetMap&quot;
              ein (
              <a
                target="_blank"
                rel="noreferrer"
              ...
              IP-Adressen und Standortdaten der Nutzer gehören, die jedoch nicht
              ohne deren Einwilligung (im Regelfall im Rahmen der Einstellungen
              ihrer Mobilgeräte vollzogen), erhoben werden. <br />
              <br />
          ...
          <p>
            <span className="ts-muster-content">
              ...
              Anbieters&nbsp;Adobe Systems Software Ireland Limited, 4-6
              Riverwalk, Citywest Business Campus, Dublin 24, Republic of
              Ireland ein.&nbsp;Adobe ist unter dem Privacy-Shield-Abkommen
          ...
          <p>
            <span className="ts-muster-content">
              Innerhalb unseres Onlineangebotes können Funktionen und Inhalte
              des Dienstes Pinterest, angeboten durch die Pinterest Inc., 635
              High Street, Palo Alto, CA, 94301, USA, eingebunden werden. Hierzu
              können z.B. Inhalte wie Bilder, Videos oder Texte und
              Schaltflächen gehören, mit denen Nutzer Inhalte dieses
              Onlineangebotes innerhalb von Pinterest teilen können. Sofern die
              Nutzer Mitglieder der Plattform Pinterest sind, kann Pinterest den
              Aufruf der o.g. Inhalte und Funktionen den dortigen Profilen der
